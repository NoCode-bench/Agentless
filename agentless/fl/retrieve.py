...
def main():
    ...
    parser.add_argument(
        "--dataset",
        type=str,
        default="Feature-Bench_Verified",
        choices=["princeton-nlp/SWE-bench_Lite", "princeton-nlp/SWE-bench_Verified", "NoCode-bench/NoCode-bench_Verified", "NoCode-bench/NoCode-bench_Full"],
